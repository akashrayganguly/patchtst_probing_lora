"""
selftest_tracker_ili.py
=======================
Same wiring check as selftest_tracker.py, but built with the ILI PatchTST
hyper-parameters (seq_len=104, patch_len=24, stride=2). Run ONCE on the HPC
(inside PatchTST_supervised/, conda env active) before submitting the full job:

    python selftest_tracker_ili.py        # expects RESULT: PASS
...
def main():
    ...
    log_dir = './grad_logs/_selftest_ili'
